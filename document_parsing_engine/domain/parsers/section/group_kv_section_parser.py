...
from document_parsing_engine.utils.text import normalize_text, normalize_key
...
class GroupKVSectionParser(BaseSectionParser):
    ...
    def _parse_zone(self, zone_items: list[BlockItem]) -> tuple[str, str]:
    ...
    def _merge_rows(self, rows_zone_kv: list[list[tuple[str, str]]]) -> dict:
        result = {}
        last_key = None
